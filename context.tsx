...
// ========= SUPABASE SETUP =========
// ATENÇÃO: Adicione aqui as suas credenciais do Supabase.
// Você pode encontrá-las em "Project Settings" > "API" no seu painel do Supabase.
// Siga as instruções no arquivo bancodedados.md para obter os valores corretos.
const supabaseUrl = 'https://nlwtfidslgakzzyiihdj.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5sd3RmaWRzbGdha3p6eWlpaGRqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI0NDc1NDAsImV4cCI6MjA2ODAyMzU0MH0.hNRVGk-3meMr1f9c2ehRuOh-ewzw56g982rx-Nr8xiI';

const areCredentialsMissing = supabaseUrl.includes('COLE_AQUI') || supabaseKey.includes('COLE_AQUI');

// To prevent the app from crashing at startup if credentials are not set,
// we provide a valid-looking dummy URL and key. The AppProvider will then
// render a warning message and prevent any real API calls from being made.
...
Por favor, edite o arquivo 'context.tsx' e adicione sua URL e Chave Anon.
    ...
    <div className="h-screen w-full flex items-center justify-center bg-dark-900 text-white p-8">
        <div className="max-w-2xl text-center bg-dark-800 p-8 rounded-lg border border-red-500 shadow-lg">
            ...
            <p className="text-gray-400">
                Por favor, siga as instruções no arquivo <code className="bg-dark-700 text-brand-light px-2 py-1 rounded">bancodedados.md</code> para criar seu banco de dados e adicione as credenciais no arquivo <code className="bg-dark-700 text-brand-light px-2 py-1 rounded">context.tsx</code>.
            </p>
        </div>
    </div>
);
