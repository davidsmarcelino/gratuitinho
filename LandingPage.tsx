...
const LandingPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // Check for existing user first. Using select('*') to avoid overly complex type inference.
            ...
            if (existingUser) {
                ...
                // We create a plain object payload first to avoid deep type instantiation errors with the Supabase client.
                ...
                const { error: insertError } = await supabase
                    .from('users')
                    .insert([{ ...newUserPayload, assessment: null }] as any);
