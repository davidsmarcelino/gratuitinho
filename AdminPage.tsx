                        ...
                        <div className="space-y-8">
                            <div className="bg-dark-900 p-6 rounded-lg border border-gray-700">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-300 mb-1">Título da Página (Aba)</label>
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-300 mb-1">Subtítulo (Hero)</label>
                                        <textarea value={settings.landingPage.heroSubtitle} onChange={(e) => handleInputChange(e, 'landingPage', 'heroSubtitle')} className="w-full bg-dark-700 border border-gray-600 rounded-md p-2 h-24"></textarea>
                                    </div>
                                </div>
                            </div>
